...
class Config(BaseSettings):
    ...
    EMAIL_PORT: int = Field(default=2525)  # 465 protected SSL
    EMAIL_USERNAME: str = Field(default="tgparsing")
    EMAIL_PASSWORD: str = Field(default="tgparsing")
    EMAIL_FROM: str = Field(default="tgparsing")
