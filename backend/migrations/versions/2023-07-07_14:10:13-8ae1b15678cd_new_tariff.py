...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tariff_id'], ['tariffs.id'], name=op.f('fk_user_subscribe_tariff_id_tariffs')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_user_subscribe_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user_subscribe')),
    sa.UniqueConstraint('user_id', name=op.f('uq_user_subscribe_user_id'))
    )
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['benefit_id'], ['benefits.id'], name='fk_tariff_benefits_benefit_id_benefits'),
    sa.ForeignKeyConstraint(['tariff_id'], ['tariffs.id'], name='fk_tariff_benefits_tariff_id_tariffs'),
