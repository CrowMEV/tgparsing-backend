...
async def get_tariff_by_id(session: AsyncSession, tariff_id: int) -> Tariff:
...
async def get_tariff_by_name(session: AsyncSession, tariff_name: str) -> Tariff | None:
...
async def change_tariff(session: AsyncSession, tariff_id: int, data: dict) -> Tariff:
    stmt = (
        sa.update(Tariff)
        .values(**data)
        .returning(Tariff)
...
async def delete_tariff_price(session: AsyncSession, tariff_price_id: int) -> None:
    stmt = (
